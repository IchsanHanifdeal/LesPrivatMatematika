...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sqld = "SELECT * FROM paket where id_guru = $id_guru";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo date('H:i', strtotime($jam_mulai)) . ' - ' . date('H:i', strtotime($jam_selesai)); ?>
                                        </td>
                                        <td>
                                            <?php echo $jumlah; ?>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-warning" href="edit.php?id_paket=<?php echo $id_paket ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger" href="#" onclick="confirmDelete(<?php echo $id_paket; ?>)">
    ...
    <script>
        function confirmDelete(id_paket) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "hapus.php?id_paket=" + id_paket;
                } else {
                    Swal.fire({
