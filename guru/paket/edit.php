        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h1 class="h3 mb-4 text-gray-800">Guru | Edit Paket</h1>
                        </div>
                    </div>
                    <form action="" method="POST">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_paket" name="nama_paket" value="<?php echo $nama; ?>" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_murid" name="jumlah_murid" value="<?php echo $jumlah_murid ?>" required>
                                </div>
                                <div class="form-group">
                        ...
                        <a href="paket.php" class="btn btn-secondary">Back</a>
                    </form>
                </div>
