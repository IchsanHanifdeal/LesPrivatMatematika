...
if (isset($_GET['id_murid'])) {
    $idToUpdate = $_GET['id_murid'];
    $sqlGetData = "SELECT * FROM murid WHERE id_murid = '$idToUpdate'";
    $resultGetData = mysqli_query($conn, $sqlGetData);

    if ($resultGetData) {
        $rowData = mysqli_fetch_assoc($resultGetData);
        $id_murid = $rowData['id_murid'];
        $nama_murid = $rowData['nama_murid'];
        $nisn = $rowData['nisn'];
        $no_hp = $rowData['no_hp'];
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h1 class="h3 mb-4 text-gray-800">Guru | Edit Murid</h1>
                        </div>
                    </div>
                    <form action="" method="POST">
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="number" style="display:none;" name="id_murid" value="<?php echo $id_murid; ?>">
                                <div class="form-group">
                                    <label for="nama_paket">Nama Murid:</label>
                                    <input type="text" class="form-control" id="nama_murid" name="nama_murid" value="<?php echo $nama_murid; ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_handphone" name="no_handphone" value="<?php echo $no_hp; ?>" required>
                                </div>
                                <div class="form-group">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE murid SET nisn = '$nisn', nama_murid = '$nama_murid', no_hp = $no_handphone, alamat = '$alamat' WHERE id_murid = '$id_murid'";
