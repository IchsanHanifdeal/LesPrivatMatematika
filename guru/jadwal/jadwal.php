                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $sqld = "SELECT * FROM jadwal";
                            $resultd = mysqli_query($conn, $sqld);

                            if ($resultd) {
                                while ($rowd = mysqli_fetch_assoc($resultd)) {
                                    $id_jadwal = $rowd['id_jadwal'];
                                    $hari = $rowd['hari'];
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-warning" href="edit.php?id_jadwal=<?php echo $id_jadwal ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger" href="#" onclick="confirmDelete(<?php echo $id_jadwal; ?>)">
        ...
        function confirmDelete(id_jadwal) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "hapus.php?id_jadwal=" + id_jadwal;
                } else {
                    Swal.fire({
