...
if (isset($_GET['id_jadwal'])) {
    $idToUpdate = $_GET['id_jadwal'];
    $sqlGetData = "SELECT * FROM jadwal WHERE id_jadwal = '$idToUpdate'";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h1 class="h3 mb-4 text-gray-800">Guru | Edit Jadwal</h1>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="number" style="display:none;" name="id_jadwal" value="<?php echo $id_jadwal; ?>">
                                    <label for="hari">Hari:</label>
                                    <?php
                                    $days = ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'];
                                    foreach ($days as $day) {
                                        $isChecked = in_array($day, explode(',', $hari)) ? 'checked' : '';
                                        echo "
                        <div class='form-check'>
                            <input type='checkbox' class='form-check-input' id='$day' name='hari[]' value='$day' $isChecked>
                                    ...
                                    <select type="text" class="form-control" id="alamat" name="guru" required>
                                        ...
                                        if ($result) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $id_guru_option = $row['id_guru'];
                                                $nama_option = $row['nama'];
                                                $selected = ($id_guru_option == $id_guru) ? 'selected' : '';
                                                echo "<option value='$id_guru_option' $selected>$nama_option</option>";
                                            }
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE jadwal SET hari = '$selected_hari', jam_mulai = '$jam_mulai', jam_selesai = '$jam_selesai', id_guru = '$selected_guru' WHERE id_jadwal = '$id_jadwal'";
