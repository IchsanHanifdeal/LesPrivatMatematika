...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Guru | Dashboard</h1>
                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?php echo $nohp; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="no_rekening" name="no_rekening" value="<?php echo $no_rekening; ?>">
                                        </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlU = "UPDATE guru SET nama='$nama', alamat='$alamat', nohp='$nohp', email='$email', no_rekening='$no_rekening' WHERE username='$username'";
